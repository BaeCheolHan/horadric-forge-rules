...
- 로컬서치 도구: `.codex/tools/deckard/` (MCP + HTTP 폴백)
...
- 설정: `.codex/config.toml`, `.codex/tools/deckard/config/config.json`
...
- 도구 문서: `codex-rules-v2.3.3-workspace-msa/.codex/tools/deckard/README.md`
